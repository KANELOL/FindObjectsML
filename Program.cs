...
using System.Linq;
using Microsoft.ML;
using myObjDetectionML.YoloParser;
using myObjDetectionML.DataStructures;

namespace myObjDetectionML
{
    class Program
    {
        ...
        {
            Console.WriteLine($"......The Objects in the image {imageName} are detected below... hehe");
